    ...
    public void paint(Graphics g) {
        ...
        switch (mode) {
            case -2: // ゲームオーバー画面
                ...
                buf_gc.drawString("     Hit SPACE bar    ", imgW / 2 - 90, imgH / 2 + 20);
                break;

            case -1: // タイトル画面
                buf_gc.setColor(Color.black);
                buf_gc.drawString("    Shooting Game    ", imgW / 2 - 80, imgH / 2 - 20);
                buf_gc.drawString("    Hit SPACE bar to start the game    ", imgW / 2 - 120, imgH / 2 + 20);
                //初期化
                score = 0;
                ftr.hp = Maxhp;
                enmyprobability = 0.3;
            ...
            default: // ゲーム中
                ...
                for (i = 0; i < ftrBltNum; i++) {
                    ...
                    ItemBlt[2 * i].move(buf_gc, imgW, imgH);
                    ItemBlt[2 * i + 1].move(buf_gc, imgW, imgH);
                }
